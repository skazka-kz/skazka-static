  ...
  [8],
  {
    147: function(e, t, a) {
      ...
      var n = a(0),
        ...
        l = a.n(d),
        s = [
          { name: "Топ ассортимент (pdf)", path: "" },
          { name: "Ассортимент для АЗС (pdf)", path: "" },
          { name: "Ассортимент для пивных магазинов (pdf)", path: "" },
          { name: "Ассортимент для аптек (pdf)", path: "" },
        ];
      t.default = function() {
        return i.a.createElement(
          o.a,
          null,
          i.a.createElement(m.a, { title: "О Нас" }),
          i.a.createElement(
            c.f,
            null,
            i.a.createElement(c.m, { src: l.a }),
            i.a.createElement(
              c.g,
              null,
              i.a.createElement(c.h, null, "Брэнды"),
              i.a.createElement(
                c.k,
                null,
                "Мы работаем с лучшими брендами Казахстана, России, Украины и Узбекистана, такими как",
                " ",
                i.a.createElement(
                  c.a,
                  null,
                  "Боржоми, Славянка, Победа, Казконд, SweetLife, Paulig, Вижер, Русский Кондитер, Зум-зум, Пионер, Mix&Max и другие.",
                  " "
                ),
                "Желаете стать партнером? ",
                i.a.createElement(r.a, { to: "/contacts" }, "Пишите нам"),
                ", или узнайте больше на странице ",
                i.a.createElement(r.a, { to: "/partners" }, "Партнёрам"),
                "."
              )
            ),
            i.a.createElement(
              c.g,
              null,
              i.a.createElement(c.h, null, "Ассортимент"),
              i.a.createElement(
                c.k,
                null,
                "Мы предоставляем огромный выбор кондитерских изделий производителей Казахстана, России, Украины и Узбекистана. Наши продукты покрывают все ценовые диапазоны, начиная от бюджетного печенья и заканчивая самым элитным шоколадом."
              ),
              i.a.createElement(c.k, null, "У нас в ассортименте:"),
              i.a.createElement(
                "ul",
                null,
                i.a.createElement("li", null, "Печенье"),
                i.a.createElement("li", null, "Пряники"),
                i.a.createElement("li", null, "Карамель"),
                i.a.createElement("li", null, "Конфеты"),
                i.a.createElement("li", null, "Батончики"),
                i.a.createElement("li", null, "Зефир"),
                i.a.createElement("li", null, "Кексы"),
                i.a.createElement("li", null, "Детские сладости с игрушкой"),
                i.a.createElement("li", null, "Сухофрукты"),
                i.a.createElement("li", null, "Кофе"),
                i.a.createElement("li", null, "Элитный чай"),
                i.a.createElement("li", null, "И другие")
              )
            ),
            i.a.createElement(
              c.g,
              null,
              i.a.createElement(c.h, null, "Листовки и прайс-листы"),
              i.a.createElement(
                c.k,
                null,
                "Здесь вы найдете список листовок и прайс листов нашей продукции. Оформить заказ, уточнить детали или наличие вы всегда можете у наших операторов. Мы работаем с ",
                i.a.createElement(c.a, null, "09:00 до 18:00"),
                " по будням,",
                " ",
                i.a.createElement(
                  r.a,
                  { to: "/contacts" },
                  "наши контактные детали"
                ),
                "."
              ),
              i.a.createElement(
    ...
    151: function(e, t, a) {
      ...
      o.a.object, o.a.string.isRequired, o.a.func, o.a.func;
    },
    153: function(e, t, a) {
      "use strict";
      a.d(t, "e", function() {
          ...
          return i.a.createElement(
            ...
            t &&
              i.a.createElement(
                ...
                i.a.createElement(l.i, { to: "/contacts" }, "Связаться с нами")
              )
          );
        };
      (b.propTypes = { isHome: o.a.bool }),
...
//# sourceMappingURL=component---src-pages-products-js-4664539dd8e9afb0bf51.js.map
